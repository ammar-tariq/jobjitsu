...
Engineering standards live in [`.cursor/rules/`](.cursor/rules/) and follow the same philosophy as the product: privacy-first, user sovereignty, honest AI, and calm craftsmanship.

Before proposing a feature, check [Non-goals](docs/product/NON_GOALS.md) and [Principles](docs/product/PRINCIPLES.md).
