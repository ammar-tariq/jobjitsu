...
| **Email / Gmail deep sync** | **PE20 in progress** (`@jobjitsu/mailbox`) — OAuth loopback in the desktop app | Opt-in OAuth; local classify/match; never auto-send. Do not duplicate in `send`. Guide: [GMAIL_AND_OUTLOOK.md](../guides/GMAIL_AND_OUTLOOK.md). |
