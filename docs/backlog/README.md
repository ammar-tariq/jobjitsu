...
**Current focus:** Follow [IMPLEMENTATION_ORDER.md](../../IMPLEMENTATION_ORDER.md). Wave 3 local intelligence — PE05-S05 offline / local-primary (this slice). Sprint ledger: [sprint-1.md](./sprint-1.md) · [VERTICAL_SLICES.md](./VERTICAL_SLICES.md). Waves: [DEPENDENCY_GRAPH.md](./DEPENDENCY_GRAPH.md) · [IMPLEMENTATION_ROADMAP.md](../../IMPLEMENTATION_ROADMAP.md) · [PROJECT_BOARD.md](./PROJECT_BOARD.md).
